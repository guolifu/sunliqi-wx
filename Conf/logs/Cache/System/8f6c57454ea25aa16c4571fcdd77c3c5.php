...
<head>
	...
	<title><?php echo ($f_siteName); ?>-后台管理系统（狗扑源码社区）</title>
	<meta name="keywords" content="<?php echo ($f_siteName); ?>-后台管理系统（狗扑源码社区出品）" />
	<meta name="description" content="<?php echo ($f_siteName); ?>-后台管理系统（狗扑源码社区出品）" />
		...
		<tr>
			<td>
				<div id="footer">
					...
					<p class="fr"> Copyright &copy; 2014-2015 狗扑源码社区 版权所有  </p>
				</div>
			</td>
		</tr>
	</table>
