...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="site_name" value="<?php echo ($f_siteName); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：狗扑源码社区</span>
	  </td>
    </tr>
	 <tr> 
	 ...
	 <tr> 
      ...
      <td><input type="text" name="site_url" value="<?php echo ($f_siteUrl); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://www.gope.cn 不要加 /</span>
    </tr> 
    <tr> 
   ...
   <tr>  
    ...
    <tr> 
      ...
      <td><input type="text" name="server_key" value="<?php echo C('server_key');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;</span> 注意狗扑提醒不要改动
    </tr>
    ...
    <tr> 
      ...
      <td><input type="text" name="server_topdomain" value="<?php echo C('server_topdomain');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;比如:gope.cn或者gope.cn.cn</span>
    </tr>
    <tr> 
    ...
    <tr> 
     ...
     <tr> 
      ...
      <td><input type="text" name="eqxsiteurl" value="<?php echo ($eqx_siteUrl); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://eqx.gope.cn 如需购买易企秀程序请直接按照说明付款399元后留言给QQ75943938 付款方式：http://www.gope.cn/jishu/264.html</span>
	...
	<tr> 
      ...
      <td><input type="text" name="site_qq" value="<?php echo ($f_qq); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:QQ:75943938</span>
    </tr>
    <tr> 
	...
	<tr> 
      ...
      <td><input type="text" name="site_email" value="<?php echo C('site_email');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:75943938@qq.com</span>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <td><textarea	 type="text" name="copyright" class="ipt" style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo C('copyright');?></textarea><span>&nbsp;&nbsp;例:狗扑源码社区版权所有</span>
    </tr>
    <tr> 
